...
/* harmony import */ var _modules_company_text__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/company-text */ "./js/modules/company-text.js");
...
/* harmony import */ var _modules_storage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/storage */ "./js/modules/storage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.form').forEach(_modules_storage__WEBPACK_IMPORTED_MODULE_5__["initForm"]);
  Object(_modules_company_text__WEBPACK_IMPORTED_MODULE_2__["initShowText"])();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_3__["initScroll"])();
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_4__["initAccordeon"])();
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_4__["resize"])();
...
/*!*********************************!*\
  !*** ./js/modules/accordeon.js ***!
  \*********************************/
/*! exports provided: initAccordeon, resize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var accordionItemWrapper = '[data-accordion-item-wrapper]';
var accordionItemContent = '[data-accordion-item-content]';
var classActive = 'footer__title--active';
var titleElements = document.querySelectorAll(accordionItem);
var handleClickItem = function handleClickItem(e) {
  var item = e.currentTarget;
  var wrapper = item.closest(accordionItemWrapper);
  var content = wrapper.querySelector(accordionItemContent);
  var isOpened = item.classList.contains(classActive);
  var allItems = document.querySelectorAll(accordionItem);
  var allContents = document.querySelectorAll(accordionItemContent);
...
var resize = function resize() {
  var lists = document.querySelectorAll(accordionItemContent);
...
/***/ "./js/modules/company-text.js":
/*!************************************!*\
  !*** ./js/modules/company-text.js ***!
  \************************************/
/*! exports provided: initShowText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initShowText", function() { return initShowText; });
var buttonElement = document.querySelector('[data-company-button]');
var textElements = document.querySelectorAll('[data-company-text]');
var pElement = document.querySelector('[data-company-hide]');
var showText = function showText() {
  var lastElem = textElements[textElements.length - 1];
  ...
  if (window.innerWidth < 767) {
    pElement.style.display = lastElem.dataset.companyText === 'open' ? 'none' : 'block';
  }
};
var initShowText = function initShowText() {
...
var phoneElement = document.querySelectorAll('[data-form="phone"]');
var initMask = function initMask() {
  phoneElement.forEach(function (element) {
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      var inputModal = modal.querySelector('[data-form="name"]');
...
var btnElement = document.querySelectorAll('[data-consult]');
...
/* harmony import */ var _mask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mask */ "./js/modules/mask.js");

var initForm = function initForm(formElement) {
  var fieldElements = formElement.querySelectorAll('[data-form]');
  fieldElements.forEach(function (fieldElement) {
    var type = fieldElement.type,
      id = fieldElement.id;
    var fieldIdentify = "field-".concat(id);
    ...
    if (type === 'tel') {
      Object(_mask__WEBPACK_IMPORTED_MODULE_0__["initMask"])();
    }
    try {
      var value = localStorage.getItem(fieldIdentify);
      if (value !== null) {
